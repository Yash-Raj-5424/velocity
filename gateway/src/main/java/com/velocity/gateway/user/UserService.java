        ...
        log.info("Validating user with ID: {}", userId);
            ...
            return userServiceWebClient.get()
                    ...
                    .onErrorResume(WebClientResponseException.class, e -> {
                        ...
                        return Mono.error(new RuntimeException("Error validating user " + userId + ": " + e.getMessage()));

                    });
    }

    public Mono<UserResponse> registerUser(UserRegisterdto userRegisterdto) {
        log.info("Validating user: {}", userRegisterdto.getEmail());
